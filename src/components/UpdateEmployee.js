  ...
  return (
    <div className='max-w-xl mx-40 bg-slate-800 my-20 rounded shadow py-4 px-8'>
        ...
        <div className='mx-10 my-2'>
            ...
            type='text'
            name="addres"
            value={employee.addres}
            onChange={(e)=> handleChange(e)}
            className="w-full py-2 my-4 text-slate-800" placeholder='Address'></input>
             <input 
            type='dob'
            name="dob"
            value={employee.dob}
            onChange={(e)=> handleChange(e)}
            className="w-full py-2 my-4 text-slate-800" placeholder='DOB'></input>
             <input 
            type='number'
            name="adhar"
            value={employee.adhar}
            onChange={(e)=> handleChange(e)}
            className="w-full py-2 my-4 text-slate-800" placeholder='Adhar'></input>
            ...
            value={employee.role}
            onChange={(e)=> handleChange(e)}
            className="w-full py-2 my-4 text-slate-800" placeholder='Job Role'></input>
        </div>
